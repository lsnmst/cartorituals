        ...
        <Fade in={open}>
          <Box sx={style}>
            ...
            <Typography id="modal-modal-description" sx={{ mt: 2 }} style={{fontSize: "0.7em", fontWeight: 400}}> 
              The archive was launched to gather resources from the workshop 'Rituals in the Cartographic Practice' organised in March 2023 at the Design Academy of Eindhoven.<br />The archive is dedicated to Indigenous peoples and ethnic minorities who re-exist epistemic racism.<br /><br />Database last update: 13<sup>th</sup> February 2026
            </Typography>
